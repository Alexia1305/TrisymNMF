...
for level in 1:nbr_level
    ...
    println(accuracy_moy3*100/nbr_test)
    println(accuracy_moy4*100/nbr_test)
    ...
    result3[level,1]=accuracy_moy3*100/nbr_test
    result3[level,2]=time3/nbr_test
    result3[level,3]=error3/nbr_test
    result3[level,4]=succes3*100/nbr_test
    result4[level,1]=accuracy_moy4*100/nbr_test
    result4[level,2]=time4/nbr_test
    result4[level,3]=error4/nbr_test
    result4[level,4]=succes4*100/nbr_test
end 
# Taille de la police
font_size = 14
...
# Nom du fichier
nom_fichier = "resultats_initssed.txt"
